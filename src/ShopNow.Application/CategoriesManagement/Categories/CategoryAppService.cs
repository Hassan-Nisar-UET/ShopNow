...
{
    internal class CategoryAppService : AsyncCrudAppService<Category, GetCategoryDto, Guid, PagedCategoryResultRequestDto, CreateCategoryDto, UpdateCategoryDto>, ICategoryAppService
    {
