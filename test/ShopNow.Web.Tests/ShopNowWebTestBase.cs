...
{
    public abstract class ShopNowWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ShopNowWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ShopNowWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ShopNowDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ShopNowDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ShopNowDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ShopNowDbContext, Task<T>> func)
        {
            T result;
